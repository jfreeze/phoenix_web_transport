defmodule WtDemo.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.deploy": [
        "tailwind wt_demo --minify",
        "esbuild wt_demo --minify",
        "phx.digest"
      ],
      # no "deps.unlock --unused": the lockfile is shared with the library, which has deps the demo lacks
